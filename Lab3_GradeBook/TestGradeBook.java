public class TestGradeBook {
    public static void main(String[] args) {
        ...
        lm121.addStudentResult(milan, 1, 7.5);
        lm121.addStudentResult(milan, 3, 5.5);
        lm121.addStudentResult(milan, 4, 12.22);

        lm121.addStudentResult(tadhg, 0, 4.4);
        ...
        lm051.addStudentResult(milan, 0, 10);
